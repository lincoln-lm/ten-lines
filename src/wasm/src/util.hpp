...
public:
    typed_array()
        : val(emscripten::val::array()) { };
    typed_array(emscripten::val v)
        : val(v) { };
    typed_array(std::vector<T> v)
        : val(emscripten::val::array())
    {
...
public:
    typed_range()
        : typed_array<T>(emscripten::val::array()) { };
    typed_range(emscripten::val v)
        : typed_array<T>(v) { };
